...
function ale_enqueue_styles() {
	...
	wp_register_style( 'aletheme_font-awesome_css', THEME_URL . '/css/font-awesome.min.css', array(), ALETHEME_THEME_VERSION, 'all');
    ...
    wp_enqueue_style('aletheme_font-awesome_css');
