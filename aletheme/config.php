...
function aletheme_get_options() {
    ...
    $options[] = array( "name" => "Select the body Font (Extended) from Google Library",
                        "desc" => "The default Font (extended) is - 400,400i,700,700i",
                        "id" => "ale_headerfontex",
    ...
    $options[] = array( "name" => "Select the Headers Font (Extended) from Google Library",
                        "desc" => "The default Font (extended) is - 400,400i,700,700i,900,900i",
                        "id" => "ale_mainfontex",
    ...
    $options[] = array( "name" => "Footer menu title",
		...
		$options[] = array( "name" => "Map Icon",
                        "desc" => "Upload a map icon or enter a map icon link",
                        "id" => "ale_mapicon",
                        "std" => "",
                        "type" => "upload");

		$options[] = array( "name" => "Map Style",
                        "desc" => "Enter a map style from snazzymaps.com",
                        "id" => "ale_mapstyle",
                        "std" => "",
                        "type" => "textarea");
...
function aletheme_metaboxes($meta_boxes) {
    ...
    $meta_boxes[] = array(
        ...
        'fields' => array(
            array(
                'name' => __('Phone Label', 'igl'),
                'desc' => __('Enter Phone Label', 'igl'),
                'id'   => $prefix . 'phone_label',
                'std' => 'Phone',
                'type' => 'text',
            ),
            array(
                'name' => __('Phone Number', 'igl'),
                'desc' => __('Enter Phone Number', 'igl'),
                'id'   => $prefix . 'phone_number',
                'type' => 'text',
            ),
            array(
                'name' => __('Address Label', 'igl'),
                'desc' => __('Enter Address Label', 'igl'),
            ...
            array(
                'name' => __('Address', 'igl'),
                'desc' => __('Enter Address', 'igl'),
                'id'   => $prefix . 'address',
                'type' => 'text',
            ),
            array(
                'name' => __('Email Label', 'igl'),
                'desc' => __('Enter Email Label', 'igl'),
